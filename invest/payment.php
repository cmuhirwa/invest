...
if (isset($_SESSION["username"])) 
	{
		...
		$link.='<a class="next-btn" href="address.php">Proceed to checkout</a>';
		$steps.='<li class="current-step"><span>01. Summary</span></li>
                                <li class="current-step"><span>02. Payment Options</span></li>
...
if (isset($_GET['index_to_remove']) && $_POST['index_to_remove'] != "") {
...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) 
{
   ...
   { 
       ...
       // $pricetotal = money_format("%10.2n", $pricetotal);
        ...
        <input type="hidden" name="amount_' . $x . '" value="' . $price/787 . '">
		...
		$cartOutput .= '<td><a href="cart.php?index_to_remove=' . $item_id . '" class="fa fa-trash-o"></a></td>';
		$cartOutput .= '</tr>';
		$i++; 
    } 
	//setlocale(LC_MONETARY, "en_US");
                        ...
                        <div class="page-order">
                            ...
                            <div class="order-detail-content">
                                <table class="table table-bordered table-responsive cart_summary">
                                    ...
                                    <tbody>
										<?php 
										$sql2 = $db->query("SELECT * FROM `paysystems1`");
										...
										while($row = mysqli_fetch_array($sql2))
													{
														...
														<td>'.$row['pRate'].'</td>
														<td>'.$row['pCharges'].'</td>
														<td>'.round($cartTotal / $row['pRate'] , 2).' '.$row['pConverstion'].'</td>
														...
														<td>'.$row['pCharges'].'</td>
														<td>'.round($cartTotal / $row['pRate'] , 2).' '.$row['pConverstion'].'</td>
														<td><div class="cart_navigation"><a class="next-btn"> Chose</a></div></td></tr>';
